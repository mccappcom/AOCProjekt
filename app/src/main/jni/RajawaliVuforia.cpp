...
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_setActivityPortraitMode(JNIEnv *,
		jobject, jboolean isPortrait) {
	isActivityInPortraitMode = isPortrait;
}

JNIEXPORT int JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_initTracker(JNIEnv *env,
		jobject object, jint trackerType) {
	LOG("Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_initTrackerox");
...
JNIEXPORT int JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_createFrameMarker(JNIEnv* env,
...
JNIEXPORT int JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_createImageMarker(JNIEnv* env,
...
JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_deinitTracker(JNIEnv *, jobject) {
	LOG("Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_deinitTracker");
...
JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaRenderer_renderFrame(JNIEnv* env,
...
JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_initApplicationNative(JNIEnv* env,
		jobject obj, jint width, jint height) {
	LOG("Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_initApplicationNative");
...
JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_deinitApplicationNative(
...
JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_startCamera(JNIEnv *env,
		jobject object) {
	LOG("Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_startCamera");
...
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaRenderer_getFOV(JNIEnv *env,
		jobject object) {
...
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaRenderer_getVideoWidth(JNIEnv *env,
		jobject object) {
	return videoWidth;
}

JNIEXPORT jint JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaRenderer_getVideoHeight(JNIEnv *env,
		jobject object) {
	return videoHeight;
}

JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_stopCamera(JNIEnv *, jobject) {
	LOG("Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_stopCamera");
...
JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_setProjectionMatrix(JNIEnv *env,
		jobject object) {
	LOG("Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_setProjectionMatrix");
...
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_autofocus(JNIEnv*, jobject) {
	return QCAR::CameraDevice::getInstance().setFocusMode(
			QCAR::CameraDevice::FOCUS_MODE_TRIGGERAUTO) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_setFocusMode(JNIEnv*, jobject,
		jint mode) {
	int qcarFocusMode;
...
JNIEXPORT int JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_destroyTrackerData(JNIEnv *env,
		jobject object) {
	LOG("Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaRenderer_destroyTrackerData");
...
JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_activateAndStartExtendedTracking(JNIEnv*, jobject) {
	activateExtendedTracking = true;
}

JNIEXPORT jboolean JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_startExtendedTracking(JNIEnv*, jobject)
{
    QCAR::TrackerManager& trackerManager = QCAR::TrackerManager::getInstance();
    QCAR::ImageTracker* imageTracker = static_cast<QCAR::ImageTracker*>(
          trackerManager.getTracker(QCAR::ImageTracker::getClassType()));
...
JNIEXPORT jboolean JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_stopExtendedTracking(JNIEnv*, jobject)
{
    QCAR::TrackerManager& trackerManager = QCAR::TrackerManager::getInstance();
    QCAR::ImageTracker* imageTracker = static_cast<QCAR::ImageTracker*>(
          trackerManager.getTracker(QCAR::ImageTracker::getClassType()));
...
JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaRenderer_initRendering(JNIEnv* env,
		jobject obj) {
	LOG("Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaRenderer_initRendering");
}

JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaRenderer_updateRendering(JNIEnv* env,
		jobject obj, jint width, jint height) {
	LOG("Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaRenderer_updateRendering");
...
JNIEXPORT int JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_initCloudReco(JNIEnv *, jobject) {
	LOG(
...
JNIEXPORT int JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_deinitCloudReco(JNIEnv *,
		jobject) {
...
JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_enterScanningModeNative(JNIEnv*,
		jobject) {
	QCAR::TrackerManager& trackerManager = QCAR::TrackerManager::getInstance();
	QCAR::ImageTracker* imageTracker =
			static_cast<QCAR::ImageTracker*>(trackerManager.getTracker(
...
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_getScanningModeNative(JNIEnv*,
		jobject) {
	return scanningMode;
}

JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_setCloudRecoDatabase(JNIEnv* env,
...
JNIEXPORT void JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_setMaxSimultaneousImageTargets(JNIEnv* env,
        jobject obj, jint maxSimImageTargets) {
    maximumSimultaneousImageTargets = (int)maxSimImageTargets;
}

JNIEXPORT jstring JNICALL
Java_pl_amu_edu_trebuh_1divoolej_aocprojekt_VuforiaActivity_getMetadataNative(JNIEnv* env,
		jobject) {
